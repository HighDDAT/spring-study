...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
      <div class="col-lg-12">
    <form role="form" id="writeForm" method="post" action="${cPath}/article/paging/modify">
        <div class="card">
...
$(document).ready(function () {
    ...
    $(".listBtn").on("click", function () {
        self.location = "${cPath}/article/paging/list?page=${section.page}&perPageNum=${section.perPageNum}";
    });
