...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
      <div class="col-lg-12">
    <form role="form" id="writeForm" method="post" action="${cPath}/article/modify">
        <div class="card">
...
$(document).ready(function () {
    ...
    $(".listBtn").on("click", function () {
        self.location = "${cPath}/article/listPaging?page=${section.page}&perPageNum=${section.perPageNum}";
    });
